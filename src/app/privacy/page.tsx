    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800/80 rounded-3xl p-6 sm:p-10 shadow-sm space-y-4 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <p>
            IdeaVerse 1000 operates primarily as a progressive web application with local data storage. We use local storage on your device to retain saved bookmarks and search preferences.
          </p>
          <h2 className="font-display font-bold text-lg text-slate-900 dark:text-white pt-2">
            2. Google AdSense & Analytics
          </h2>
          <p>
            We use Google AdSense and Google Analytics to display advertising and evaluate web performance. These services use cookies in accordance with Google Consent Mode v2.
          </p>
        </div>
      </main>
